...
1. **先加载 `.Codex/skills/parallel-development/` skill**,按其中的「Merge orchestration」节执行——skill 是执行指令,本 skill 是角色化补充。
...
### 1. 读必读材料
- `AGENTS.md`、`parallel-development` skill、`.Codex/workflow.json`。
