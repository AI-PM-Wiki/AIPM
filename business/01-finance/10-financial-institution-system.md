...
flowchart TD
    central[中央银行]
    central --> commercial[商业银行]
    central --> specialized[专业银行]
    central --> nonbank[非银行金融机构]
    commercial --> credit[存贷款与结算]
    specialized --> targeted[特定领域金融服务]
    nonbank --> market[证券、保险、信托与租赁]
```

现代金融机构体系以中央银行统筹、商业银行承担主要信用中介，并由专业机构补充不同金融功能。
