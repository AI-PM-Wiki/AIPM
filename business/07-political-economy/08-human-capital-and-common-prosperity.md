...
```mermaid
flowchart LR
    education[教育、培训与健康] --> human[人力资本]
    human --> productivity[劳动生产率与就业质量]
    productivity --> income[收入水平]
    income --> wealth[财富积累]
    wealth --> opportunity[下一代机会]
```

人力资本把教育、劳动生产率、收入和代际机会连接成长期分配链条，是共同富裕中扩大机会均等的重要渠道。
