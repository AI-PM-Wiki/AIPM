...
flowchart TD
    institutions[国际金融机构]
    institutions --> global[全球性机构]
    institutions --> regional[区域性机构]
    global --> bis[BIS：中央银行合作]
    global --> imf[IMF：货币合作与救助]
    global --> worldbank[世界银行：发展融资]
    global --> fsb[FSB：金融稳定协调]
    regional --> development[区域发展与基础设施融资]
```

国际金融机构按全球或区域范围分工，在监管协调、危机救助、发展融资和基础设施建设中发挥不同作用。
