...
不同公司称呼不同。课程以百度的「功能型产品经理 / 策略型产品经理」和腾讯的「产品策划 / 产品运营」为例：前者更多聚焦功能设计，后者更多与规则和数值打交道。名称不能直接决定职责，判断一个岗位时应看它实际解决问题的手段和交付物。先对照[策略产品经理](../../../job/product-manager-types/internet-product-manager.md#策略产品经理)。
