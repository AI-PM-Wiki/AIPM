---
description: 主流模型能力与定价速览（2026-08-23 快照）：推理模型机制、选型维度、多模型路由与评估清单
---

## 模型能力与选型:推理模型时代

2025 年起，推理模型（reasoning model）把「思考」变成可调用的产品资源，模型能力地图随之重构：同一系列内，想得多深、花多少钱、等多久，成为产品经理需要显式决策的变量。信息截至 2026-08-23，结论均引自各厂商官方文档、官方博客与官方仓库。
...
> 以上来源均为官方文档、官方博客或官方仓库，访问验证日期 2026-08-23。模型列表与价格变动频繁，以各官方页面为准。
