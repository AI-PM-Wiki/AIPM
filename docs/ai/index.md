...
本栏目是 AI 产品经理的技术通识课：不讲怎么训练模型，讲清楚 **AI 能做什么、不能做什么、怎么用**，帮助你在产品决策中理解技术边界、与工程师高效协作。内容按知识类分卷，每个知识类拆多篇：先有地基（机器学习/深度学习/Transformer），再到大模型（训练、推理、能力边界），再到各应用技术（多模态、提示词、RAG、Agent），最后是评估与系统架构。
