...
| [01-poisson-process.md](01-Poisson%20过程.md) | 泊松过程的定义、数字特征、样本曲线、到达时刻与间隔时间分布、条件分布、合并分解、复合泊松过程、非齐次泊松过程与多维泊松点过程 |
...
| [06-mcmc-and-stochastic-simulation.md](06-MCMC%20与随机模拟.md) | Metropolis-Hastings 算法与遍历定理、Kolmogorov 环路准则，及股票价格首达时、破产概率、排队系统应用 |
