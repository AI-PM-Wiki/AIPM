...
对 AI 产品从业者，这是金融与财务的领域知识底座：做金融、量化或投研类产品，需要货币、利率、市场与估值的语言；做商业化与定价，会计与公司金融给出成本、收益与资本结构的判断框架；Agent 在投研、风控、合规等场景落地，则需要宏观、固定收益与金融工程的底子。它与本站其他专题的分工：[产品方法论](../pm/index.md)回答「怎么判断、怎么设计」，[AI 基础](../ai/index.md)回答「模型能做什么」，本专题回答「金融与财务课堂知识怎么运转」，[垂直领域 · 金融](../vertical/finance/index.md)回答「银行、支付、保险、资本市场和监管机构怎么做产品」。
...
| 课程 | 对应 PM 能力 |
|---|---|
| 计量经济学 | 因果推断、回归、A/B 实验评估——数据 PM 核心 |
| 概率论与数理统计 | 显著性检验、置信区间，A/B 测试的数学基础 |
| 行为与实验经济学 | 用户行为 + 实验设计，最贴近用户研究 |
| 微观经济学 → 中级微观 | 需求、市场结构、激励设计，理解用户与商业模式的底层框架 |

### T2 商业/数据底色

| 课程 | 对应 PM 能力 |
|---|---|
| 会计学 | 看懂财报、业务成本，商业 sense 基础 |
| 中级财务会计学 | 财务分析加深一层 |
| 数字经济前沿专题 | 互联网/平台商业模式认知 |
| 创新创业专题 | 0→1 产品思维、商业闭环 |

### T3 赛道相关

| 课程 | 适用赛道 |
|---|---|
| 金融学、公司金融 | 金融/支付/理财/信贷类产品 |
| 商业银行经营与管理 | 银行/信贷产品 |
| 国际金融学、国际贸易学 | 跨境支付、出海/跨境电商 |
| 证券投资学、行为金融 | 证券/财富管理、用户非理性决策 |
| 经济法 | 合规/风控类产品 |
