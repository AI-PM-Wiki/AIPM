...
???+ note "持续更新中"
    ...
    2. 产品经理 又称品牌经理（Brand Manager）。是企业守门员、品牌塑造者、更是营销骨干。它既是一套完善的营销运作制度，更是博大精深的营销操作。举凡产品从创意到上市，所有相关的研发、调研、生产、编预算、广告、促销活动等等，都由产品经理掌控。
    欢迎[参与贡献](intro/htc.md)一起完善！
