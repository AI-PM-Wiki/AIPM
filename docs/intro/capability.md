---
description: AI 产品经理能力模型：用产品判断、系统理解、评测观测、代理权治理、交付与商业五维组织可观察证据，并给出四级责任、岗位映射和自测清单，对应产品方法论栏目的能力出口。
---
...
可交付物包括问题定义、用户旅程、需求取舍记录、价值假设、基线数据和可行性 spike 计划。本站[产品方法论](../pm/index.md)栏目主要对应这一维：把机会、用户、需求、设计和商业判断收成可验证的任务。
...
-   将只读、生成草稿、确认后执行、受限自治和全自主区分开，口径与 [AI 产品开发生命周期](../pm/ai-lifecycle.md) 的 L0–L4 一致
...
???+ note "与求职专题岗位解读的关系"
    ...
    具体 JD 的关键词、面试准备和作品建议见求职专题：[产品经理岗位类别](../job/product-manager-types/index.md)、[产品经理协作团队与岗位](../job/positions/index.md)、[AI 产品经理岗位解读](../job/positions/ai-pm.md)。

    行业与交付型岗位需要的领域规则、工作流和监管约束见[垂直领域](../vertical/index.md)。
