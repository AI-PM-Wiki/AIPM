...
-   **文心大模型**：2023 年 3 月率先公开发布文心一言（对话产品），C 端产品经历「文心一言 → 文小言（2024 年）→ 文心 App（2025 年 11 月 5.0 版起）」多次更名，是国内发布最早的对话式大模型产品之一（[财中社](https://finance.eastmoney.com/a/202511203569923022.html)、[界面新闻](https://m.jiemian.com/article/13679643.html)）
...
代表性产品线：文心 App（C 端对话，原「文心一言/文小言」）、千帆（B 端平台）、萝卜快跑（自动驾驶出行）。
