...
[常见岗位与JD](positions/index.md)：AI 产品经理、大模型应用工程师与 Agent 工程师、算法工程师、提示词工程师等产品与技术岗，数据、评测与训练类岗位（含 AI 训练相关岗位），设计师、研发、测试、硬件等协作岗，以及 AI Infra、FDE 与高管岗位，共 13 个岗位方向的职责拆解与 JD 解读。
