...
**建议**：入行前先对照[AI 产品经理能力模型](../../intro/capability.md)自评，把通用产品技能补到位，再叠加 AI 认知。本站[学习路线](../../case/roadmap.md)的阶段零与阶段一按这个顺序设计，可以直接参照。
...
**建议**：第一年把重心放在**建立信息获取系统**和**动手做完整项目**上，而不是背知识点。重度使用 2-3 款主流 AI 产品、记录惊喜与失望时刻、做一两个可演示的 demo，产出 10 条「AI 能力边界」笔记：这些都是[学习路线](../../case/roadmap.md)里可落地的动作。
