...
2.  按[产品拆解](../../case/teardown.md)框架走：定位（帮谁/解决什么/为什么现在做）→ 任务场景 → 技术方案（为什么这么选）→ 交互与体验（如何建立信任、出错如何兜底）→ 商业（收费/成本/护城河）→ 成败归因
...
3.  按[产品拆解](../../case/teardown.md)框架完整拆 1 个你常用的 AI 产品
