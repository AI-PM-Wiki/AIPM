...
| 岗位 | 一句话定位 | 详见 |
| --- | --- | --- |
| AI 产品经理 | 定义「做什么、为什么做」，负责需求、方案与结果 | [AI 产品经理](ai-pm.md) |
...
| 数据、评测与训练类岗位 | 数据标注与管理、评测、数据科学——AI 质量的「守门人」；训练相关详见独立页 [AI 训练相关岗位](ai-trainer.md) | [数据、评测与训练类岗位](data-ai-trainer.md) |
