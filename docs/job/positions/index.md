---
description: 常见岗位与 JD：AI 产品、技术、行政与管理岗位全景，职责边界、JD 关键词、绩效考核与产品经理协作地图
---
...
AI 公司从产品研发到组织运营，大致需要以下角色（按产品协作链路与组织支持排列）：
...
| 行政岗位 | 保障办公与组织运营，覆盖采购、资产、场地、供应商、员工服务与行政管理 | [行政岗位与 JD 解读](administrative-roles.md) |
...
-   [行政岗位与 JD 解读](administrative-roles.md)：行政专员、行政主管、行政经理、办公室主任等岗位的职责、能力与面试准备
-   [绩效管理与考核](performance-management.md)：目标设定、过程辅导、评审校准、奖金关系、PIP 与求职者提问清单

## 产品经理与各岗位的协作

产品经理要和每个岗位协作：算法、设计、研发、测试、硬件、行政等岗位各有不同的协作界面，相关页面讲清分工、协作流程、产出物与常见摩擦（大模型应用工程师篇在开篇也给出了与 PM 的协作界面）。协作地图如下：
...
-   [与行政岗位的协作](administrative-roles.md#与相关岗位的分工)：预算、采购、场地与员工服务的职责交接
