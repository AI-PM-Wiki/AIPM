...
AI 产品的合规与安全不是「上线前补的检查项」，而是**产品设计的约束条件**。本页整理 AI 产品经理必须知道的红线：数据、内容、算法、版权四类约束，每条都回答三个问题——**影响设计吗？影响数据流吗？影响上线节奏吗？**
...
???+ note "本页的边界"
    本页写**法规框架与红线**（PM 要知道「哪里不能碰」）；产品机制（脱敏怎么实现、删除权怎么做、保留期怎么定）见 [数据隐私与用户控制](data-privacy.md)，内容安全的检测实现与护栏指标见 [内容安全与护栏](content-safety.md)。法规条目以官方发布为准（引用日期 2026-08），不构成法律意见。
