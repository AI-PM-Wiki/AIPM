...
| **NoSQL** | 非关系型数据库的统称，包含文档、键值、列式和图等模型 | 先按访问模式选型，不代表不需要结构、不支持事务或一定更快 |
...
- [RAG 检索增强生成](../ai/rag.md)：向量检索、知识库与生成链路
...
- [Elasticsearch：Data in, data out](https://www.elastic.co/guide/en/elasticsearch/reference/current/documents-indices.html)
