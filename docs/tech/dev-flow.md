...
工程侧怎么把需求变成线上产品、按什么节奏推进。本页讲工程视角的端到端流程、敏捷迭代与灰度回滚；产品侧的需求判断、排期与发布节奏见 [项目管理与迭代](../pm/project-management.md)。
...
**灰度**：小流量先上，验证再放量，把上线风险控制在最小范围。与全量一次性暴露不同，灰度按比例逐步放开，异常可随时中止。
...
产品侧视角：灰度节奏、变更通知与数据口径见 [项目管理与迭代](../pm/project-management.md#发布管理) 的「发布管理」节。
