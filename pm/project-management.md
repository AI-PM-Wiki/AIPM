...
**软件开发项目 = 项目管理 × 软件工程 × 领域知识**。项目里的范围、时间、成本管理，软件工程不负责；软件工程里的架构、测试、质量实践，项目管理也覆盖不到。产品经理要懂的是两者的分工：项目管理管按时按质，软件工程管造得对不对；具体要懂到哪一层，见[能力模型](../intro/capability.md)里的「② AI 系统与工程理解」。
