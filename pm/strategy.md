---
description: 产品战略与竞争：用五力、STP、护城河和一页纸战略判断在哪个市场竞争、凭什么赢，并回答套壳、模型趋同与产品市场契合（PMF）怎么落到优先级。
---
...
STP 的上游是[需求分析](requirements.md)的机会识别：机会是「市场阶段 × 竞争位置 × 公司目标 × 技术可行性 × 数据资产」交叉后的候选空间。市场阶段用词与[产品生命周期](product-lifecycle.md)对齐：早期 = 导入期，增长 = 成长期。STP 把这个空间收敛成一个明确的战场：
...
**产品市场契合**（product-market fit）是战略阶段判断，不是功能清单：目标市场里的用户，是否因为这个产品而改变了完成任务的方式，并且愿意留下、付费或推荐。

Sean Ellis 的常用门槛是：若把产品拿掉，至少约 40% 的用户会表示「非常失望」。AI 产品还要加两条：推理与护栏成本覆盖得住；评测和线上采纳能证明价值不是一次 Demo。

| 信号 | 更像尚未契合 | 更像已经契合 |
| --- | --- | --- |
| 留存 | 用一次就走，召回靠补贴 | 核心任务形成重复使用 |
| 口碑 | 要解释很久才有人试 | 用户能转述定位，并主动推荐 |
| 付费 | 只在优惠或试点里发生 | 有人按标价续费或扩席 |
| 成本 | 用量一涨毛利变负 | 毛利与延迟仍在护栏内 |

0 到 1 先验证契合，再谈护城河。把套壳做大、把平台先搭起来，都替代不了「有人反复用、并且账算得过来」。契合之后的放大，见后文护城河建设节奏与[商业化与增长](monetization.md)。
...
AI 适用性评估：**模型层极强，应用层较弱**。大模型层的规模经济与资本门槛共同构成赢家通吃的推手；应用层的推理成本占比随用量上升，规模经济反而要防「规模不经济」——用户越多推理成本越高（见[商业化与增长](monetization.md#成本优化的三个杠杆)）。应用层的成本优势更多来自工程优化（模型路由、缓存、小模型）而非单纯规模。
...
**战略画布**（金伟灿与莫博涅，《蓝海战略》2005）：横轴列出行业竞争的要素，纵轴是各要素的价值水平，画出「行业价值曲线」与「本产品价值曲线」。两条曲线重合度高说明在红海里同质化竞争；战略就是通过**剔除、减少、增加、创造**四个动作让两条曲线分叉。对 AI 应用：行业曲线常是「全能对话、通用能力、免费」，差异化曲线可以是「垂直任务深度、行业知识、可审计」。战略画布看竞争差异；商业模式画布的九格与 AI 填法见[商业化与增长](monetization.md#商业模式画布)。
