...
| 分类 | 页面 | 核心决策问题 |
| --- | --- | --- |
| 对话助手类 | [对话助手](chatbot.md)、[智能语音产品](voice-product.md)、[客服自动化](support-bot.md) | 冷启动、上下文与记忆、低延迟与可打断、信任 |
...
- 架构改动小：接模型 API / 中间层，做能力与数据接入（见 [AI 系统架构](../ai/architecture.md) 的四层地图与 [系统架构基础](../tech/architecture.md) 的请求链路）
...
- 架构围绕模型能力设计：上下文管理、工具调用、护栏与成本护栏（见 [AI 系统架构](../ai/architecture.md)、[系统架构基础](../tech/architecture.md)、[Agent 产品设计](agent-product.md)）
...
-   **做智能语音产品**:[智能语音产品](voice-product.md) → [对话助手](chatbot.md) → [出海与合规](compliance.md)
    先选一个窄任务并用级联管线跑通，再围绕低延迟、打断、唤醒和音色授权扩展；涉及客服时接着阅读 [客服自动化](support-bot.md)。
